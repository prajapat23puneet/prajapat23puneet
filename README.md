...
*Building distributed systems and scalable backend solutions that power enterprise applications*

[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-puneet.is--a.dev-4A90E2?style=for-the-badge)](https://puneet.is-a.dev)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin)](https://linkedin.com/in/puneet-prajapat)
[![Email](https://img.shields.io/badge/Email-puneetcodes@gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:puneetcodes@gmail.com)
...
var engineer = new SoftwareDeveloper
{
    ...
    CurrentFocus = "Modernizing legacy systems with .NET 8 & building fault-tolerant microservices",
    Achievements = "Improved CI/CD pipeline stability from 60% → 85% across 5,000 test cases"
};
```
...
- ✅ Optimistic Concurrency for high-load scenarios
- ✅ Event-driven architecture using MassTransit
...
- ✅ RedLock for distributed data integrity
- ✅ Deployed on Fly.io edge network
...
![AI](https://img.shields.io/badge/Gemini_2.0-8E75B2?style=flat-square&logo=google&logoColor=white)

- ✅ Self-hosted n8n workflow automation
- ✅ Gemini 2.0 Flash for semantic analysis
- ✅ Dynamic resume tailoring & ATS scoring
- ✅ Predictive hiring manager email discovery
...
![MassTransit](https://img.shields.io/badge/MassTransit-2E8B57?style=for-the-badge)
...
**Open to exciting opportunities in distributed systems, backend engineering, and cloud architecture**

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Let's_Connect-0077B5?style=for-the-badge&logo=linkedin)](https://linkedin.com/in/puneet-prajapat)
[![Portfolio](https://img.shields.io/badge/Portfolio-View_My_Work-4A90E2?style=for-the-badge&logo=google-chrome&logoColor=white)](https://puneet.is-a.dev)
[![Email](https://img.shields.io/badge/Email-Say_Hello-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:puneetcodes@gmail.com)

![Visitors](https://visitor-badge.laobi.icu/badge?page_id=prajapat23puneet)

⭐️ From [prajapat23puneet](https://github.com/prajapat23puneet)
